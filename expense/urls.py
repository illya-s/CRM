...
urlpatterns = [
    ...
    path('c/', views.categoryes, name="expense_categoryes"),
    path('c/l/', views.category_list, name="expense_category_list"),
    ...
    path('p/', views.platforms, name="expense_platforms"),
    path('p/l/', views.platform_list, name="expense_platform_list"),
